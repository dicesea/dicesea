...
const Tileleshs = styled.p`
  color: #222222;
  font-size: 14px;
  font-weight: 600;
`;

const Wdsfsfsffs = styled.div`
  display: flex;
  gap: 10px;
...
const Footer = () => {
  ...
  return (
    <F1k5wjb5>
      <W1nwvqds>
        <Tileleshs>© {currentYear} DiceSea, Limited.</Tileleshs>
        <Wdsfsfsffs className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
          <a href={social.facebook} target="_blank" rel="noopener">
            <svg
              ...
              width="32px"
            >
              <title data-testid="svgTitle" id="title_0.8063554975946696">
                facebook
              </title>
          ...
          {/* <a href={social.instagram} target="_blank" rel="noopener">
            <svg
              ...
              width="32px"
            >
              <title data-testid="svgTitle" id="title_0.8715270987228747">
                instagram
              </title>
          ...
          {/* <a href={social.x} target="_blank" rel="noopener">
            <svg
              enableBackground="new 0 0 24 24"
              viewBox="0 0 24 24"
              height="32px"
              width="32px"
            >
              <title data-testid="svgTitle" id="title_0.03120610878122143">
                x
              </title>
          ...
          <a href={social.tiktok} target="_blank" rel="noopener">
            <svg
              ...
              width="32px"
            >
              <title data-testid="svgTitle" id="title_0.8342996171824346">
                tiktok
              </title>
          ...
          <a href={social.youtube} target="_blank" rel="noopener">
            <svg
              ...
              width="32px"
            >
              <title data-testid="svgTitle" id="title_0.3041808255103411">
                youtube
              </title>
          ...
          <a href={social.linkedIn} target="_blank" rel="noopener">
            <svg
              ...
              width="32px"
            >
              <title data-testid="svgTitle" id="title_0.16857988873502272">
                linkedin
              </title>
          ...
          {/* <a
            ...
            aria-label="DiceSea email address"
          >
            <svg
              enableBackground="new 0 0 24 24"
              viewBox="0 0 24 24"
              ...
              style={{ marginTop: "3px" }}
            >
              <title data-testid="svgTitle" id="title_0.37611351505572865">
                email
              </title>
